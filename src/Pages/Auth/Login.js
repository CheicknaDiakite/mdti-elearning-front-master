        ...
        <div className="col-lg-5 col-md-8 py-8 py-xl-0">
            ...
            <div className="card-body p-6">
                ...
                <span>
                    ...
                    <a href="/auth/register" className="ms-1">Sign up</a>
                </span>
                </div>
                {/* Form */}
                <form className="needs-validation" onSubmit={handleSubmit(onSubmit)} >
                    ...
                    <div className="mb-3">
                        ...
                        />
                        {errors.username && <div className="invalid-feedback">Please enter valid username.</div>}
                    ...
                    <div className="mb-3">
                        ...
                        />
                        {errors.password && <div className="invalid-feedback">Please enter valid password.</div>}
